...
//Current ID - Message ID generated by the target - Add one everytime I use it
//Respto - Current ID received by Zedboard
//TimeStamp - just grab from the continuous timer
